...
let notificationsVisible = true; // Initialize the variable
...
function funkcija2() {
  ...
  // Toggle the notifications container visibility
  notificationsVisible = !notificationsVisible;

  // Set the display property based on the toggle state
  notificationsContainer.style.display = notificationsVisible
    ? "block"
    : "none";
}
